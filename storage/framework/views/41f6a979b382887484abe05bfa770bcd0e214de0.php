...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/normalize.css')); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('css/global.css')); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('css/layout.css')); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('css/sections.css')); ?>" media="screen">
</head>
    ...
    <header id="header-nav" class="column-btw-center">
        <nav class="main-menu row-btw">
            ...
            <ul class="row-center">
                ...
                <li><a href="/">Je vends mes produits</a></li>
                <li><a href="/">Je gère mes annonces</a></li>
            </ul>
        </nav>
...
</html><?php /**PATH C:\xampp\htdocs\marche_du_coin\resources\views/layout.blade.php ENDPATH**/ ?>